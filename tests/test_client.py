...
class TestMailClient:
    ...
    def test_fetch_emails_returns_list(
        self,
        client: MailClient,
        mock_imap_mailbox: MagicMock,
        mock_imap_message: MagicMock
    ) -> None:
    ...
    def test_send_email_with_multiple_recipients(self, client: MailClient, mock_smtp: MagicMock) -> None:
    ...
    def test_mark_as_read_with_empty_uids(self, client: MailClient, mock_imap_mailbox: MagicMock) -> None:
    ...
    def test_mark_as_starred_with_empty_uids(self, client: MailClient, mock_imap_mailbox: MagicMock) -> None:
    ...
    def test_move_emails_with_empty_uids(self, client: MailClient, mock_imap_mailbox: MagicMock) -> None:
    ...
    def test_delete_emails_success(
        self,
        client: MailClient,
        mock_imap_mailbox: MagicMock
    ) -> None:
    ...
    def test_delete_emails_with_empty_uids(self, client: MailClient, mock_imap_mailbox: MagicMock) -> None:
